...
func main() {
	...
	newContent := replaceAvailableResourcesSection(string(templateContent), table)
...
func replaceAvailableResourcesSection(templateContent, newTable string) string {
	...
	// The new content starts with the table
	newSection := newTable
