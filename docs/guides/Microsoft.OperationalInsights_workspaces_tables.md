...
* `type` - (Required) The type of the resource. This should be set to `Microsoft.OperationalInsights/workspaces/tables@api-version`. The available api-versions for this resource are: [`2020-03-01-preview`, `2020-08-01`, `2020-10-01`, `2021-12-01-preview`, `2022-10-01`, `2023-09-01`].
...
## Import
 ...
 terraform import azapi_resource.example /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{resourceName}/tables/{resourceName}?api-version=2023-09-01
 ```
