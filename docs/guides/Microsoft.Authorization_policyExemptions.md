...
* `type` - (Required) The type of the resource. This should be set to `Microsoft.Authorization/policyExemptions@api-version`. The available api-versions for this resource are: [`2020-07-01-preview`, `2022-07-01-preview`].
...
## Import
 ...
 terraform import azapi_resource.example {any azure resource id}/providers/Microsoft.Authorization/policyExemptions/{resourceName}?api-version=2022-07-01-preview
 ```
