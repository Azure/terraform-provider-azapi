...
* `type` - (Required) The type of the resource. This should be set to `Microsoft.DocumentDB/mongoClusters/firewallRules@api-version`. The available api-versions for this resource are: [`2023-03-01-preview`, `2023-03-15-preview`, `2023-09-15-preview`, `2023-11-15-preview`, `2024-02-15-preview`, `2024-03-01-preview`, `2024-06-01-preview`, `2024-07-01`, `2024-10-01-preview`, `2025-04-01-preview`, `2025-07-01-preview`, `2025-08-01-preview`, `2025-09-01`].
...
## Import
 ...
 terraform import azapi_resource.example /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/mongoClusters/{resourceName}/firewallRules/{resourceName}?api-version=2025-09-01
 ```
