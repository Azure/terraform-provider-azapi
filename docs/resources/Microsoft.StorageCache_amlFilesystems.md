...
* `type` - (Required) The type of the resource. This should be set to `Microsoft.StorageCache/amlFilesystems@api-version`. The available api-versions for this resource are: [`2023-03-01-preview`, `2023-05-01`, `2023-11-01-preview`, `2024-03-01`, `2024-07-01`, `2025-07-01`, `2026-01-01`].
...
## Import
 ...
 terraform import azapi_resource.example /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorageCache/amlFilesystems/{resourceName}?api-version=2026-01-01
 ```
