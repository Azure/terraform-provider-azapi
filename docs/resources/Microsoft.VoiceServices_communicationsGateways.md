...
* `type` - (Required) The type of the resource. This should be set to `Microsoft.VoiceServices/communicationsGateways@api-version`. The available api-versions for this resource are: [].
