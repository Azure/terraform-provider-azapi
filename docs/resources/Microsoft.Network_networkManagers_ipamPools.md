...
* `type` - (Required) The type of the resource. This should be set to `Microsoft.Network/networkManagers/ipamPools@api-version`. The available api-versions for this resource are: [`2024-01-01-preview`, `2024-05-01`, `2024-07-01`, `2024-10-01`, `2025-01-01`, `2025-03-01`].
...
## Import
 ...
 terraform import azapi_resource.example /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkManagers/{resourceName}/ipamPools/{resourceName}?api-version=2025-03-01
 ```
