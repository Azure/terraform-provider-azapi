...
* `type` - (Required) The type of the resource. This should be set to `Microsoft.Cache/redis/firewallRules@api-version`. The available api-versions for this resource are: [`2016-04-01`, `2017-02-01`, `2017-10-01`, `2018-03-01`, `2019-07-01`, `2020-06-01`, `2020-12-01`, `2021-06-01`, `2022-05-01`, `2022-06-01`, `2023-04-01`, `2023-05-01-preview`, `2023-08-01`, `2024-03-01`, `2024-04-01-preview`, `2024-11-01`, `2025-08-01-preview`].
...
## Import
 ...
 terraform import azapi_resource.example /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cache/redis/{resourceName}/firewallRules/{resourceName}?api-version=2025-08-01-preview
 ```
