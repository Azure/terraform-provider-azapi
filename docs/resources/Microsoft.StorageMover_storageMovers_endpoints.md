...
* `type` - (Required) The type of the resource. This should be set to `Microsoft.StorageMover/storageMovers/endpoints@api-version`. The available api-versions for this resource are: [`2022-07-01-preview`, `2023-03-01`, `2023-07-01-preview`, `2023-10-01`, `2024-07-01`, `2025-07-01`, `2025-08-01`, `2025-12-01`, `2026-05-01`].
...
## Import
 ...
 terraform import azapi_resource.example /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorageMover/storageMovers/{resourceName}/endpoints/{resourceName}?api-version=2026-05-01
 ```
