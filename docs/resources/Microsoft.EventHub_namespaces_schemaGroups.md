...
* `type` - (Required) The type of the resource. This should be set to `Microsoft.EventHub/namespaces/schemaGroups@api-version`. The available api-versions for this resource are: [`2021-11-01`, `2022-01-01-preview`, `2022-10-01-preview`, `2023-01-01-preview`, `2024-01-01`, `2024-05-01-preview`, `2025-05-01-preview`, `2026-01-01`].
...
## Import
 ...
 terraform import azapi_resource.example /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventHub/namespaces/{resourceName}/schemaGroups/{resourceName}?api-version=2026-01-01
 ```
