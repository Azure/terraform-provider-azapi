...
page_title: "accounts/connections"
description: |-
  Manages a Cognitive Services Account Connection.
---

# Microsoft.CognitiveServices/accounts/connections - Cognitive Services Account Connection

This article demonstrates how to use `azapi` provider to manage the Cognitive Services Account Connection resource in Azure.
...
* `type` - (Required) The type of the resource. This should be set to `Microsoft.CognitiveServices/accounts/connections@api-version`. The available api-versions for this resource are: [`2025-04-01-preview`, `2025-06-01`, `2025-07-01-preview`, `2025-09-01`, `2025-10-01-preview`, `2025-12-01`, `2026-01-15-preview`, `2026-03-01`, `2026-03-15-preview`, `2026-05-01`, `2026-05-15-preview`, `2026-07-01`, `2026-07-15-preview`].
...
* `body` - (Required) Specifies the configuration of the resource. More information about the arguments in `body` can be found in the [Microsoft documentation](https://learn.microsoft.com/en-us/azure/templates/Microsoft.CognitiveServices/accounts/connections?pivots=deployment-language-terraform).
...
## Import
 ...
 terraform import azapi_resource.example /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.CognitiveServices/accounts/{resourceName}/connections/{resourceName}
 
 # It also supports specifying API version by using the resource id with api-version as a query parameter, e.g.
 terraform import azapi_resource.example /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.CognitiveServices/accounts/{resourceName}/connections/{resourceName}?api-version=2026-07-15-preview
 ```
