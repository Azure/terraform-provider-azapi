...
* `type` - (Required) The type of the resource. This should be set to `Microsoft.Insights/dataCollectionRuleAssociations@api-version`. The available api-versions for this resource are: [`2019-11-01-preview`, `2021-04-01`, `2021-09-01-preview`, `2022-06-01`, `2023-03-11`, `2024-03-11`].
...
## Import
 ...
 terraform import azapi_resource.example //providers/Microsoft.Insights/dataCollectionRuleAssociations/{resourceName}
 
 # It also supports specifying API version by using the resource id with api-version as a query parameter, e.g.
 terraform import azapi_resource.example //providers/Microsoft.Insights/dataCollectionRuleAssociations/{resourceName}?api-version=2024-03-11
 ```
