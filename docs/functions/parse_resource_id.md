...
The `object` returned from `parse_resource_id` has the following attributes:
...
- `subscription_id` (String) The id of the subscription this resource resides in.
