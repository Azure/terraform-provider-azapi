...
func Test_NewDataPlaneResourceId(t *testing.T) {
	...
	for _, v := range testData {
		...
		actual, err := NewDataPlaneResourceId(v.Name, v.ParentId, v.ResourceType)
		if err != nil {
			if v.Error {
				continue
			}
...
func Test_DataPlaneResourceIDWithResourceType(t *testing.T) {
	...
	for _, v := range testData {
		...
		actual, err := DataPlaneResourceIDWithResourceType(v.ResourceId, v.ResourceType)
		if err != nil {
			if v.Error {
				continue
			}
