...
func ResourceResourceListDataSource() *schema.Resource {
	return &schema.Resource{
		Read: resourceResourceListDataSourceRead,
...
func resourceResourceListDataSourceRead(d *schema.ResourceData, meta interface{}) error {
