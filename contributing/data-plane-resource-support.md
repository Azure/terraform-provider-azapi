# Data-Plane Resource Support

The AzAPI provider supports Azure data-plane resources through the `azapi_data_plane_resource` resource type. This guide describes how to add support for new data-plane resources or customize behavior for existing ones.
